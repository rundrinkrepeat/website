...
declare module 'ical.js' {
	...
	export class Time {
		...
		public static SUNDAY = 1 as const;
		public static MONDAY = 2 as const;
		public static TUESDAY = 3 as const;
		public static WEDNESDAY = 4 as const;
		public static THURSDAY = 5 as const;
		public static FRIDAY = 6 as const;
		public static SATURDAY = 7 as const;

		public dayOfWeek(startOfWeek: number): number;
	}
